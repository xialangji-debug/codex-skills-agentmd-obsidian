...
```powershell
python "%USERPROFILE%\.codex\skills\skill-usage-tracker\scripts\skill_usage_tracker.py" report
```

Useful commands:

```powershell
python "%USERPROFILE%\.codex\skills\skill-usage-tracker\scripts\skill_usage_tracker.py" scan
python "%USERPROFILE%\.codex\skills\skill-usage-tracker\scripts\skill_usage_tracker.py" report
python "%USERPROFILE%\.codex\skills\skill-usage-tracker\scripts\skill_usage_tracker.py" trends
python "%USERPROFILE%\.codex\skills\skill-usage-tracker\scripts\skill_usage_tracker.py" otel-serve
python "%USERPROFILE%\.codex\skills\skill-usage-tracker\scripts\skill_usage_tracker.py" latest
python "%USERPROFILE%\.codex\skills\skill-usage-tracker\scripts\skill_usage_tracker.py" pending
python "%USERPROFILE%\.codex\skills\skill-usage-tracker\scripts\skill_usage_tracker.py" feedback --rating useful --note "PDF skill helped; browser was unnecessary" --best pdf --unneeded browser
```

`report`, `trends`, `latest`, and `pending` query the database by default. Add `--scan` only when a fresh incremental import is needed:

```powershell
python "%USERPROFILE%\.codex\skills\skill-usage-tracker\scripts\skill_usage_tracker.py" report --scan
```
...
```powershell
python "%USERPROFILE%\.codex\skills\skill-usage-tracker\scripts\skill_usage_tracker.py" registry-audit
```
...
```powershell
python "%USERPROFILE%\.codex\skills\skill-usage-tracker\scripts\skill_usage_tracker.py" registry-audit `
  --active-root "%USERPROFILE%\.codex\skills" `
  --disabled-root "%USERPROFILE%\.codex\skills.disabled" `
  --index "%USERPROFILE%\Documents\Obsidian\CodexVault\Codex\agent\skills-index.md" `
...
```powershell
python "%USERPROFILE%\.codex\skills\skill-usage-tracker\scripts\skill_usage_tracker.py" report --source official
python "%USERPROFILE%\.codex\skills\skill-usage-tracker\scripts\skill_usage_tracker.py" report --source logs
python "%USERPROFILE%\.codex\skills\skill-usage-tracker\scripts\skill_usage_tracker.py" report --source both
```

For a specific turn:

```powershell
python "%USERPROFILE%\.codex\skills\skill-usage-tracker\scripts\skill_usage_tracker.py" feedback --turn <turn_id> --rating ok --skill pdf=useful --skill browser=unneeded
```
