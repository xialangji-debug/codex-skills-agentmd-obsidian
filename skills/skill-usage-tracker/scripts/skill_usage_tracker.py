...
def cmd_registry_audit(args: argparse.Namespace) -> None:
    from registry_audit import run
...
def build_parser() -> argparse.ArgumentParser:
    ...
    registry_audit = sub.add_parser(
        "registry-audit",
        help="Read-only audit of active, disabled, plugin, and indexed skill routes",
    )
    registry_audit.add_argument("--active-root", type=Path, default=CODEX_HOME / "skills")
    registry_audit.add_argument("--disabled-root", type=Path, default=CODEX_HOME / "skills.disabled")
    registry_audit.add_argument(
        "--index",
        type=Path,
        default=HOME / "Documents" / "Obsidian" / "CodexVault" / "Codex" / "agent" / "skills-index.md",
    )
